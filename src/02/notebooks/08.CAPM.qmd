...
Separamos el rendimiento del benchmark y Calculamos la matriz de covarianza para todos los activos

Sea el vector aleatorio de rendimientos de $n$ activos:
$$
\mathbf{R} =
\begin{bmatrix}
R_1 \\
...
\end{bmatrix},
\qquad
\mu = \mathbb{E}[\mathbf{R}].
$$

La matriz de covarianza $\Sigma \in \mathbb{R}^{n\times n}$ se define como:
$$
\Sigma
=
...
Con esto calculado ahora podemos calcular lo que se entiende por la beta de cada activo

```{python}
#Beta de los activos de forma individual
